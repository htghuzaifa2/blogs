...
Arch doesnâ€™t install everything automatically. First, ensure NetworkManager is present.
...
```
If you see **active (running)** â€” your service is fine.
...
lsusb
```
Youâ€™ll see something like: `Network controller: Intel Corporation Wireless 8265 / 8275`. If you see no output, your system isnâ€™t detecting your adapter â†’ skip to Step 5.
...
ip link
```
You should see something like `wlan0` or `wlp2s0`. If you see it but Wi-Fi still doesnâ€™t show up, your driver is loaded, but NetworkManager may need a restart:
```bash
...
If youâ€™re using a desktop environment, make sure you have the network applet installed:
...
-   Reboot â€” your Wi-Fi should now work permanently.
