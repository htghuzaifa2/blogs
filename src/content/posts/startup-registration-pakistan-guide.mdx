...
date: "2025"
excerpt: "In 2025, your startup goes from idea to legal entity in 72 hoursâ€”if you dodge the paperwork potholes."
author: "Huzi"
category: "Business"
---
...
**Pay Fee**: â‚¨ 1,000 online (â‚¨ 2,000 offline) via JazzCash/credit card [2][10].
...
| CNIC/Passport Copies           | All directors/shareholders (scanned, attested) | â€”                                   |
| Proof of Registered Office     | Utility bill/lease agreement + property tax slip | â€”                                   |
| Digital Signatures             | Obtain via NIFT for directors (â‚¨ 1,500/person) | [2][6]                              |
...
-   SMC: â‚¨ 2,000â€“â‚¨ 20,000 (based on capital)
-   Pvt Ltd: â‚¨ 3,000â€“â‚¨ 30,000 [8][10].

### Step 5: Receive Certificate of Incorporation [2][6][10]

-   **Timeline**: 3â€“5 days (normal), 4 hours via Fast Track (â‚¨ 5,000 extra) [3][10].
...
-   Mandatory if revenue > â‚¨ 10M/year; apply via FBR portal [10].
...
|-----------------------|-------------------|-------------------|
| Name Reservation      | â‚¨ 1,000           | â‚¨ 1,000           |
| Incorporation         | â‚¨ 2,000â€“â‚¨ 20,000  | â‚¨ 3,000â€“â‚¨ 30,000  |
| Digital Signatures    | â‚¨ 1,500/director  | â‚¨ 1,500/director  |
| Fast Track (4 hrs)    | â‚¨ 5,000           | â‚¨ 5,000           |

### Critical Warnings & Pro Tips [2][8][10]

-   **Deadlines**: Complete NTN/bank account within 30 days of incorporation to avoid penalties.
-   **Scam Alert**: Never pay "agents" for SECP submissionsâ€”use only the eServices portal.
-   **SMC Advantage**: 100% foreign ownership allowed; no local director required [8].
-   **Common Rejections**:
    -   Mismatched CNIC addresses â†’ Attach utility bill in directorâ€™s name.
    -   "Generic name" (e.g., "Pakistan Solutions") â†’ Add unique keywords ("AlphaLogix").

### One-Screen Cheat Sheet

1.  **Choose structure**: SMC (solo) / Pvt Ltd (team)
2.  **Reserve name**: `eservices.secp.gov.pk` â†’ Pay â‚¨1,000
3.  **Prepare**: MoA, AoA, CNICs, digital signatures
4.  **Submit docs + pay fee**: â‚¨2Kâ€“â‚¨30K
5.  **Download Certificate of Incorporation** (3â€“5 days)
6.  **Post-reg**: NTN + bank account + annual filings

*"In 2025, your startupâ€™s first MVP is a Certificate of Incorporation."*

Share this guide with co-foundersâ€”dodge the bureaucracy, launch faster!
