...
-   Pakistan plant-based scene: Impossibleâ„¢ nuggets at "The Sauce" (Karachi), Beyondâ„¢ burgers at "Burger Lab" (Lahore) "” vegan biryani pop-ups in Islamabad.
...
-   Pakistan peek: no lab-grown meat yet, but Impossibleâ„¢ nuggets = "gateway drug" to plant-based.
-   Home hack: **try "Impossibleâ„¢ mince" in "keema matar"** "” family won"™t notice, planet will applaud.
...
| ----------------- | -------------------------------------------------------------- | ------------------------------------------------------------------ |
| KFC Pakistan      | Beyondâ„¢ nuggets                                                | Karachi, Lahore outlets "” tastes like "gateway drug" to plant-based |
| Burger Lab        | Impossibleâ„¢ burgers                                            | Lahore, Islamabad "” "Impossibleâ„¢ keema" = "gateway drug" to plant-based |
| Nestlé Pakistan   | plant-based Miloâ„¢                                              | supermarket shelves "” chocolate milk without the moo               |
...
| Beef burger                 | Impossibleâ„¢ burger twice a week| meets climate target, **tastes like "gateway drug"**                  |
