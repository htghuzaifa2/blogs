...
â€œEvery hour counts when your money is on the line.â€

Here are the step-by-step paths for reporting a fake bank transaction to the State Bank of Pakistan (SBP), Banking Mohtasib, and your own bankâ€”all updated for 2025.

### âš ï¸ Act Fast â€“ The 24-Hour Rule
...
| :--- | :--- |
| **24/7 Helpline** | Call the toll-free number (e.g., UBL 111-825-888, HBL 111-111-425) and say **â€œfraudulent transactionâ€** to get connected to the fraud department immediately. |
| **Branch Visit** | Fill out a **Dispute Form** and attach an FIR copy (if applicable) within 5 working days. |
| **Bank App / Internet Banking** | Use the â€œReport Fraudâ€ or â€œDispute Transactionâ€ button. Upload screenshots and the FIR. |
...
| **Helpline** | `021-111-727-273` (Monâ€“Fri 9 AMâ€“5 PM) | For guidance and follow-up |
...
**Required Docs**: Proof of 45-day wait, bankâ€™s reply, and your CNIC. The decision usually comes within 2 months.

### ðŸš” Step 4 â€“ File an FIR (For Large Fraud)
...
Details: On [date], an amount of â‚¨ [amount] was debited without my consent from my account [number] via [ATM/IBFT/etc.].
...
### ðŸ“‹ Checklist â€“ Required Documents
...
Bookmark this page and act immediatelyâ€”every hour counts.
