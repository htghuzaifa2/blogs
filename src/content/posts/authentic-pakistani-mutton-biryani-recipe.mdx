...
author: "Huzi"
category: "Lifestyle"
excerpt: "Mutton biryani is a slow symphony â€“ where tough meat surrenders to spices through patience and steam."
---

*Serves 6-8 | Prep: 1 hr | Marinate: Overnight | Cook: 2 hrs*

"Mutton biryani is a slow symphony â€“ where tough meat surrenders to spices through patience and steam."

### ðŸ§‚ Marination Ingredients
...
*\*Saffron milk = Â½ cup warm milk + 1 tsp saffron threads (crushed)*

### ðŸ‘¨â€ðŸ³ Step-by-Step Instructions

#### 1. Marinate Mutton (Night Before)
Mix all marinade ingredients â†’ coat mutton thoroughly.
Cover â†’ refrigerate (âš ï¸ Papaya paste breaks down collagen).

#### 2. Brown Mutton (20 mins)
Heat Â¼ cup ghee in heavy pot â†’ sear mutton on HIGH 5 mins/side until caramelized.
Remove â†’ set aside.

#### 3. Build Masala (15 mins)
Same pot â†’ add remaining ghee.
Fry 1.5 cups fried onions â†’ stir in marinated mutton.
Cook 10 mins â†’ add Â½ cup water â†’ cover â†’ simmer 45 mins until meat is 80% tender.
âš ï¸ Add potatoes now if using.

#### 4. Prepare Rice
Wash rice â†’ soak 30 mins â†’ drain.
Boil water with whole spices â†’ add rice â†’ cook until 50% done (grain snaps when bent).
Drain â†’ spread on tray â†’ sprinkle 2 tbsp ghee to prevent sticking.

#### 5. Layering (The Art)
1.  **Base**: Spread mutton masala + potatoes
2.  **Herb Layer**: Â½ mint + Â½ coriander + green chilies
3.  **Onion Layer**: Â½ fried onions
4.  **Rice Layer**: Cover with 50% rice
5.  **Perfume**: Drizzle Â½ saffron milk + kewra + rose water
6.  **Repeat**: Herbs â†’ onions â†’ rice â†’ saffron mix
7.  **Seal**: Cover with foil + tight lid (dough seal for perfect *dum*)

#### 6. Dum Cooking (Magic Steam)
Cook on LOW heat 35 mins â†’
Turn off â†’ rest 20 mins (âš ï¸ NO PEEKING - steam builds flavor).
**Pro Tip:** Place tawa/griddle under pot for even heat.

### ðŸŒŸ Traditional Techniques
...
#### Dum Secrets:
- Coal smoking: Place live coal in foil cup on biryani â†’ add ghee â†’ cover (adds smokiness)
- Weighted lid: Place heavy object on lid (e.g., mortar)

### ðŸ½ï¸ Serving Ritual
Gently mix layers â†’ garnish with:
...
#### Leftover Hack:
- **Biryani Omelette**: Mix with eggs â†’ pan-fry
- **Biryani Paratha**: Stuff in dough â†’ griddle

Bookmark this recipe â€“ your gateway to Eid feasts and wedding-worthy spreads! ðŸŽ‰
